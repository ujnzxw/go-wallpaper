...
<head>
  ...
  <link rel="styleSheet" href="/static/bootstrap-switch-master/dist/css/bootstrap4/bootstrap-switch.min.css" type="text/css">
  ...
  <script type="text/javascript">
    $(function(){
        var switchSelector = '.switch input'
        var switchUrl      = 'switchChange'
        ...
        $('#go-wallpaper-switch').bootstrapSwitch('state', {{.GoWallpaperSwitchState}}); // true || false
        $(switchSelector).on('switchChange.bootstrapSwitch', function(event, state) {
            ...
            if ($('div.alert').length === 0) {
                $('.form-horizontal').append($('<div>').addClass('alert alert-info'));
            };
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    alert("Go Wallpaper Switch has been turned " + data['value'] + "!");
                },
                error: function(data) {
                    alert("Go Wallpaper Switch changes failed!");
                }
            });
        });
    })
...
<body>
  <header>
    <h1 class="logo">Welcome to Go Wallpaper</h1>
    <div class="description">
      Make a real time earth picture as your wallpaper<br/>
    </div>
  </header>

  <form class="form-horizontal">
      <div class="control-group">
          <label class="control-label" for="go-wallpaper-switch">Go Wallpaper Configuration</label>
          <div class="controls">
              <div class="switch" tabindex="0" data-on="success" data-off="warning">
                  Turn On/Off Go Wallpaper <input type="checkbox" id="go-wallpaper-switch" data-on-text="ON" data-off-text="OFF"/>
              </div>
          </div>
      </div>
  </form>
